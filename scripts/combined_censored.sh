...
IPV4_RU_CENSORED_INPUT=(${BASE_PATH}/*_multi_russia-censored_ipv4/stat/combined*FROM-AS*.tex)

IPV4_OUTPUT=/home/havok/Documents/ripetor/run_gabriel/real_2022/combined-censored
mkdir -p ${IPV4_OUTPUT}

# Remove all spaces and other funky characters from the latex tables
echo "Nospacing IPv4 DE input"
for i in ${IPV4_RU_CENSORED_INPUT}; do
  filename=$(basename $i)
